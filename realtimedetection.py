# Python file to detect facial emotions in real time and upload them to Firebase
...
firebase_admin.initialize_app(cred, {
     'databaseURL':'repalce this with the url of your firebase database'
})

# Define a function to upload data to Firebase
def upload_to_firebase(name, age, emotion):
    # Create a reference to the specified path in the Realtime Database
    ref = db.reference('emotions/' + name + '/' + age)

    # Set data at the specified path in the Realtime Database
    ref.set({
        'name': name,
        'age': age,
        'emotion': emotion
